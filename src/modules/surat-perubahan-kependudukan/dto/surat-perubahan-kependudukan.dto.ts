...
export const findAllSuratPerubahanKependudukanSchema = z.object({
  ...
  limit: z.coerce
    .number()
    .int()
    .min(1, 'Jumlah limit perhalaman minimal 1')
    .max(100, 'Jumlah limit perhalaman maksimal 100')
    .optional()
    .default(20),
...
export type FindAllSuratPerubahanKependudukanDto = z.infer<
  typeof findAllSuratPerubahanKependudukanSchema
>;
