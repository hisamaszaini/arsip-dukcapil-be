...
export class SuratPerubahanKependudukanController {
  ...
  async update(
    ...
    return this.suratPerubahanKependudukanService.update(suratId, body, files, userId, isAdmin);
  }
  ...
  removeFile(
    ...
    if (req.user.role !== "ADMIN") {
      return this.suratPerubahanKependudukanService.removeFile(+id, req.user.userId);
    }
