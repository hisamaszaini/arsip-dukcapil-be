  ...
  async getDashboardData() {
    try {
      ...
      const allActivities = [
        ...
        ...lastKehilangan.map((r) => ({
          ...r,
          jenisLayanan: 'Surat Kehilangan',
        })),
        ...lastPindah.map((r) => ({
          ...r,
          jenisLayanan: 'Surat Permohonan Pindah',
        })),
        ...lastPerubahan.map((r) => ({
          ...r,
          jenisLayanan: 'Surat Perubahan Kependudukan',
        })),
      ];
  ...
  async getDashboardDataOperator(id: number) {
    try {
      ...
      const allActivities = [
        ...
        ...lastPerubahan.map((r) => ({
          ...r,
          jenisLayanan: 'Perubahan Kependudukan',
        })),
      ];
