...
export const roleUserEnum = z.enum(['ADMIN', 'OPERATOR']);

export const statusUserEnum = z.enum(['ACTIVE', 'INACTIVE']);
...
export const createSchema = z
  .object({
    ...
    password: z
      ...
      .min(6, 'Password wajib diisi minimal 6 karakter'),
    confirmPassword: z
      .string()
      .nonempty('Konfirmasi password wajib diisi')
      .min(6, 'Konfirmasi Password wajib diisi minimal 6 karakter'),
  })
